...
Idmef::IDMEFValue::IDMEFValueTypeEnum IDMEFPath::getValueType(int depth) const
{
        return (Idmef::IDMEFValue::IDMEFValueTypeEnum) idmef_path_get_value_type(_path, depth);
}
