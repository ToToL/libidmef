...
#ifndef _LIBIDMEF_IDMEF_CLASS_HXX
#define _LIBIDMEF_IDMEF_CLASS_HXX
...
namespace Idmef {
        class IDMEFClass {
            ...
            public:
                ...
                Idmef::IDMEFValue::IDMEFValueTypeEnum getValueType(void);
                ...
                Idmef::IDMEFCriterion::IDMEFCriterionOperatorEnum getApplicableOperator(void);
        };
};
