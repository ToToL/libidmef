...
static uint64_t get_current_time(libidmef_ident_t *ident)
{
        uint64_t now;
...
static void uuidgen(libidmef_ident_t *ident)
{
        uint64_t timestamp;
 ...
 *
 * Create a new #libidmef_ident_t object with an unique value.
 *
 * Returns: 0 on success, or a negative value if an error occured.
 */
int libidmef_ident_new(libidmef_ident_t **ret)
{
        libidmef_ident_t *new;
...
/**
 * libidmef_ident_generate:
 * @ident: Pointer to a #libidmef_ident_t object.
 * @out: #libidmef_string_t where the ident will be generated.
 *
...
int libidmef_ident_generate(libidmef_ident_t *ident, libidmef_string_t *out)
{
        ...
        return libidmef_string_sprintf(out, "%8.8x-%4.4x-%4.4x-%2.2x%2.2x",
...
/**
 * libidmef_ident_destroy:
 * @ident: Pointer to a #libidmef_ident_t object.
 *
 * Destroy a #libidmef_ident_t object.
 */
