...
#ifndef _LIBIDMEF_IDMEF_PATH_H
#define _LIBIDMEF_IDMEF_PATH_H
...
int idmef_path_new(idmef_path_t **path, const char *format, ...) LIBIDMEF_FMT_PRINTF(2, 3);

int idmef_path_new_v(idmef_path_t **path, const char *format, va_list args) LIBIDMEF_FMT_PRINTF(2, 0);
